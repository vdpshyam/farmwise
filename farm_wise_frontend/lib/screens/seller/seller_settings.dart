...
import 'seller_app_settings.dart';
import 'seller_order_history_screen.dart';
import 'seller_payment_settings_screen.dart';
      ...
      children: [
            ...
            Navigator.of(context).push(
              MaterialPageRoute(
                builder: (BuildContext context) =>
                    const SellerProfileSettingsScreen(),
              ),
            );
          },
          child: const Column(
        ...
        InkWell(
          onTap: () {
            ...
            Navigator.of(context).push(
              MaterialPageRoute(
                builder: (BuildContext context) =>
                    const SellerPaymentSettingsScreen(),
              ),
            );
          },
          child: const Column(
        ...
        InkWell(
          onTap: () {
            ...
            Navigator.of(context).push(
              MaterialPageRoute(
                builder: (BuildContext context) => const SellerReviewsScreen(),
              ),
            );
          },
          child: const Column(
