...
class SellerOrderScreenPendingOrderWidget extends StatelessWidget {
  const SellerOrderScreenPendingOrderWidget({
    super.key,
    required this.order,
    required this.updatePendingOrdersListFunc,
  });

  final OrderScreenPendingOrderWidgetModel order;
  final Function updatePendingOrdersListFunc;
                ...
                http
                  ...
                  if (response.statusCode == 200) {
                    ...
                    if (rejectOrderResp["message"] == "Order updated") {
                      updatePendingOrdersListFunc(order.orderId);
