...
class BuyerPostedByYouReviewWidget extends StatefulWidget {
  const BuyerPostedByYouReviewWidget({
    super.key,
    required this.userReview,
    required this.updateReviewsListFunc,
  });

  final PostedUserReview userReview;
  final Function updateReviewsListFunc;

  @override
  State<BuyerPostedByYouReviewWidget> createState() =>
      _BuyerPostedByYouReviewWidgetState();
}

class _BuyerPostedByYouReviewWidgetState
    extends State<BuyerPostedByYouReviewWidget> {
  @override
  void initState() {
    super.initState();
  }
              ...
              onPressed: () {
                ...
                http
                  ...
                  if (replyResp["message"] == "User review deleted") {
                    widget.updateReviewsListFunc(widget.userReview.reviewId);
